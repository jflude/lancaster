...
CFLAGS := \
	...
	-DFILE_MAJOR_VERSION=$(FILE_MAJOR_VERSION) \
	-DFILE_MINOR_VERSION=$(FILE_MINOR_VERSION) \
	-DWIRE_MAJOR_VERSION=$(WIRE_MAJOR_VERSION) \
	-DWIRE_MINOR_VERSION=$(WIRE_MINOR_VERSION)
