...
#define INVALID_CAPACITY (CACHESTER_ERROR_BASE - 24)
#define INVALID_OPEN_FLAGS (CACHESTER_ERROR_BASE - 25)
#define INVALID_RECORD (CACHESTER_ERROR_BASE - 26)
#define INVALID_DEVICE (CACHESTER_ERROR_BASE - 27)
#define INVALID_FORMAT (CACHESTER_ERROR_BASE - 28)
#define INVALID_NUMBER (CACHESTER_ERROR_BASE - 29)
